...
const groupsService = __importStar(require("../services/groups.service"));
const http_status_codes_1 = __importDefault(require("http-status-codes"));
const getMany = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let resp;
    try {
        resp = yield groupsService.getMany();
    }
    catch (err) {
        return next(err);
    }
...
const getManyShort = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let resp;
    try {
        resp = yield groupsService.getManyShort();
    }
    catch (err) {
        return next(err);
    }
...
const getOne = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let resp;
    try {
        resp = yield groupsService.getOne(req.params.id);
    }
    catch (err) {
        return next(err);
    }
...
const update = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let resp;
    try {
        resp = yield groupsService.update(req.params.id, req.body);
    }
    catch (err) {
        return next(err);
    }
...
const create = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let resp;
    try {
        resp = yield groupsService.create(req.body);
    }
    catch (err) {
        return next(err);
    }
...
const deleteOne = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let resp;
    try {
        resp = yield groupsService.deleteOne(req.params.id);
    }
    catch (err) {
        return next(err);
    }
